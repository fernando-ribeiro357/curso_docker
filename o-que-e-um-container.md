...
2. Especifique `welcome-to-docker` na entrada de pesquisa e selecione o botão **Pull**.
    ...
    ![Uma captura de tela do Painel do Docker Desktop mostrando o resultado da pesquisa para a imagem Docker welcome-to-docker](/get-started/docker-concepts/the-basics/what-is-a-container/images/search-the-docker-image.webp?border=true&w=1000&h=700)
...
6. Em **Host port** (Porta do host), especifique `8080`.
    ...
    ![Uma captura de tela do Painel do Docker Desktop mostrando a caixa de diálogo de execução do container com welcome-to-docker digitado como nome do container e 8080 especificado como número da porta](/get-started/docker-concepts/the-basics/what-is-a-container/images/run-a-new-container.webp?border=true&w=550&h=400)
...
![Captura de tela da visualização de containers da GUI do Docker Desktop mostrando o container welcome-to-docker rodando na porta do host 8080](/get-started/docker-concepts/the-basics/what-is-a-container/images/view-your-containers.webp?border=true&w=750&h=600)
...
![Captura de tela da página inicial vinda do container em execução](/get-started/docker-concepts/the-basics/what-is-a-container/images/access-the-frontend.webp?border)
...
3. Selecione a aba **Files** (Arquivos) para explorar o sistema de arquivos isolado do seu container.
    ...
    ![Captura de tela do Painel do Docker Desktop mostrando os arquivos e diretórios dentro de um container em execução](/get-started/docker-concepts/the-basics/what-is-a-container/images/explore-your-container.webp?border)
...
3. Selecione a ação **Stop** (Parar) na coluna **Actions** (Ações).
    ...
    ![Captura de tela do Painel do Docker Desktop com o container welcome selecionado e preparado para parar](/get-started/docker-concepts/the-basics/what-is-a-container/images/stop-your-container.webp?border)

**Usando a CLI (Linha de Comando)**

Siga as instruções para executar um container usando a CLI:

1. Abra seu terminal CLI e inicie um container usando o comando [`docker run`](/reference/cli/docker/container/run/):
...
Você pode verificar se o container está ativo e rodando usando o comando [`docker ps`](/reference/cli/docker/container/ls/):
...
![Captura de tela da página inicial do servidor web Nginx, vinda do container em execução](/get-started/docker-concepts/the-basics/what-is-a-container/images/access-the-frontend.webp?border)
...
2. Forneça o ID ou nome do container ao comando [`docker stop`](/reference/cli/docker/container/stop/):
...
- [Executando um container](/engine/containers/run/)
...
[O que é uma imagem?](/get-started/docker-concepts/the-basics/what-is-a-container/what-is-an-image)
